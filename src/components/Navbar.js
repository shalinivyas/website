                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav ml-auto">
                        ...
                        {/* <li className="nav-item resume-button"> */}
                            <a className="resume-button nav-link" target="_blank" smooth={true} offset={-80} href="https://drive.google.com/file/d/1UQnI3ijNVBDoVuAKhZ_SKeO_n_DT2zFD/view?usp=sharing">Resume</a>
                        {/* </li> */}
                    </ul>
                </div>
            </div>
